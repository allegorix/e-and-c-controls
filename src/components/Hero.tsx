...
export const Hero: React.FC<HeroProps> = ({ onOpenEstimator }) => {
  return (
    <section className="relative pt-32 pb-20 md:pt-40 md:pb-28 overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[350px] bg-blue-50 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          {/* Top Status Pill */}
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-white/80 border border-orange-500/40 text-orange-300 text-xs font-semibold backdrop-blur-md shadow-lg shadow-orange-950/40 animate-in fade-in slide-in-from-top-3">
          ...
          {/* Key Feature Bullets */}
          <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-6 text-xs sm:text-sm font-medium text-slate-600 pt-2">
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/80 border border-slate-200/80 text-slate-800 hover:text-slate-900 hover:border-orange-500/50 hover:bg-slate-100/80 font-bold text-sm backdrop-blur-md transition flex items-center justify-center gap-2"
            >
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          <div className="p-5 rounded-2xl bg-white/60 border border-orange-500/20 backdrop-blur-xl relative overflow-hidden group hover:border-orange-500/40 transition">
            ...
            <div className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
              ₹2,031+ <span className="text-base font-bold text-blue-600">Lakhs</span>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white/60 border border-orange-500/20 backdrop-blur-xl relative overflow-hidden group hover:border-orange-500/40 transition">
            ...
            <div className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight">
              110 <span className="text-base font-bold text-blue-600">kV</span>
            </div>
            <p className="text-xs text-slate-500 mt-1">
      ...
      <div className="mt-12 text-center">
        <a
          ...
          className="inline-flex items-center justify-center p-2 rounded-full bg-white/80 border border-slate-200 text-slate-500 hover:text-orange-300 hover:border-orange-500/40 transition animate-bounce"
        >
